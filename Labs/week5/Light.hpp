...
public:
	...
	virtual Eigen::Vector3f getDirection(const Eigen::Vector3f& surfaceLocation) override
	{
		...
		// *** YOUR CODE HERE ***
		throw std::invalid_argument("Ambient light does not have a direction");
		return Eigen::Vector3f::Zero();
		// *** END YOUR CODE ***
	}
	...
	virtual Eigen::Vector3f getLightLocation() override
	{
		...
		// *** YOUR CODE HERE ***
		throw std::invalid_argument("Ambient light does not have a location");
		return Eigen::Vector3f::Zero();
		// *** END YOUR CODE ***
	}
};
...
public:
	...
	virtual Eigen::Vector3f getLightLocation() override
	{
		...
		// *** YOUR CODE HERE ***
		throw std::invalid_argument("Directional light does not have a location");
		return Eigen::Vector3f::Zero();
		// *** END YOUR CODE ***
	}
};	
...
public:
	...
	virtual Eigen::Vector3f getIntensityAt(const Eigen::Vector3f& surfaceLocation) override
	{
		...
		return _intensity * (1 / (distance * distance));
		//return Eigen::Vector3f::Zero();
		// *** END YOUR CODE ***
	}
	...
	virtual Eigen::Vector3f getDirection(const Eigen::Vector3f& surfaceLocation) override
	{
		...
		// *** YOUR CODE HERE ***
		Eigen::Vector3f dir = (surfaceLocation - _location).normalized();
		return dir;
		//return Eigen::Vector3f::Zero();
		// *** END YOUR CODE ***
	}
...
public:
	...
	virtual Eigen::Vector3f getIntensityAt(const Eigen::Vector3f& surfaceLocation) override
	{
		...
		// *** YOUR CODE HERE ***
		float distance = (surfaceLocation - _location).norm();
		float dotProduct = _direction.dot(getDirection(surfaceLocation));
		if (dotProduct > _cosAngle) {
			return _intensity * (1 / (distance * distance));
		}
		return Eigen::Vector3f::Zero();
		// *** END YOUR CODE ***
